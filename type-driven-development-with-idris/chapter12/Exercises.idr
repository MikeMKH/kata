...
countEmpty Empty = increase 1 -- update (+1)
...
badSite : Article
badSite = MkArticle "Bad Page" "http://www.example.com/bad" (MkVotes 5 47)

goodSite : Article
goodSite = MkArticle "Good Page" "http://www.example.com/good" (MkVotes 101 7)
